...
public class PageInfo<T extends Serializable> implements Serializable {
	 ...
	 * @param list
	 */
	public PageInfo(int totalCount, int totalPage, int pageCurrent, int pageSize, List<T> list) {
	...
	public static<T> PageInfo of(int totalCount, int totalPage, int pageCurrent, int pageSize, List<T> list){
		return new PageInfo(totalCount,totalPage,pageCurrent,pageSize,list);
	}
