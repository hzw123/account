...
import cn.mauth.account.server.SysServiceServer;
...
public class SysServiceController extends BaseController{
    ...
    public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysService sysService, ModelMap modelMap){
        modelMap.put("page", service.listForPage(pageCurrent, pageSize, sysService));
        modelMap.put("pageCurrent", pageCurrent);
        modelMap.put("pageSize", pageSize);
        modelMap.put("bean", sysService);
    }
    ...
    public String save(@ModelAttribute SysService qo){
