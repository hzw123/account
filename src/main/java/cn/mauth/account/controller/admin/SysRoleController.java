...
public class SysRoleController extends BaseController {
	...
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysRole qo, ModelMap modelMap) {
	...
	public String save(@ModelAttribute SysRole qo) {
	...
	public String update(@ModelAttribute SysRole qo) {
