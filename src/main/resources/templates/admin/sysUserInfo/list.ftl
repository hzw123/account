	...
	<table class="table table-bordered table-hover table-top" data-toggle="tablefixed" data-selected-multi="true">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<@shiro.hasPermission name="/admin/sysUserInfo/view">
					    <a href="${base}/admin/sysUserInfo/view?id=${bean.id}" class="btn btn-blue" data-toggle="dialog" data-id="sysUserInfo-view" data-options="{title:'查看', height:250}">查看 </a>
					</@shiro.hasPermission>

					<@shiro.hasPermission name="/admin/sysUserInfo/edit">
					    <a href="${base}/admin/sysUserInfo/edit?id=${bean.id}" class="btn btn-green" data-toggle="dialog" data-id="sysUserInfo-edit" data-options="{title:'修改', height:350}">修改 </a>
					</@shiro.hasPermission>
					...
					<@shiro.hasPermission name="/admin/sysUserInfo/set">
						<#if bean.userType == 1>
