...
<div class="bjui-pageContent">
    <form action="${base}/admin/sysServer/save" data-toggle="validate" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="serverNo" value="" placeholder="服务号" size="20">
        </div>
        <div class="form-group">
            <label class="control-label x85">服务名称：</label>
            <input type="text" name="name" value="" placeholder="服务名称" size="20">
        </div>
        <div class="form-group">
            <label class="control-label x85">服务类型：</label>
            <input type="text" name="version" value="" placeholder="服务类型" size="20">
        </div>
        <div class="form-group">
