...
<div class="bjui-pageContent">
    <form action="${base}/admin/sysLogLogin/update" data-toggle="validate" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="gmtCreate" value="${(bean.gmtCreate?string('yyyy-MM-dd HH:mm:ss'))!}"
                   placeholder="创建时间" size="20">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="lastLoginTime" value="${(bean.lastLoginTime?string('yyyy-MM-dd HH:mm:ss'))!}"
                   placeholder="上次登录时间" size="20">
        </div>
    </form>
</div>
